namespace EAExport.Model
{
    ...
    public class CsvDoorsTreePlainExportTest
    {
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC01-TitleOnly.xml")) {
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC02-TitleWithBody.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC03-TitleWithBodyParagraphs.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC04-MultipleRequirements.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC05-NestedRequirements1.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC06-NestedRequirements2.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC07-SpecialQuotes.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC20-FormattingBold1.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC21-FormattingBold2.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC22-FormattingItalics.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC23-FormattingUnderline.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC24-FormattingSuperscript.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC25-FormattingSubscript.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC26-FormattingMultiple.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC27-QuotesInTitle.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC40-OrderedList1.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC41-OrderedList2.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC42-ItemizedList1.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC43-ItemizedList2.xml")) {
                Assert.That(sr.ReadLine(), Is.EqualTo("EAID;EAParent;Heading;Text"));
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC44-BothLists1.xml")) {
                //<ol>
                //&#xA; -> <li>Ordered List<ol>
                //&#xA; -> <li>Itemized List</li>
                //&#xA;</ol>
        ...
        {
            using (StreamReader sr = LoadXmi(@"XMI\TC45-BothLists2.xml")) {
                //<ul>
